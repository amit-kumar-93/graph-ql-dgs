...
public class Director {
  ...
  public static com.amit.types.Director.Builder newBuilder() {
    return new Builder();
  }
  ...
  public static class Builder {
    ...
    public Director build() {
                  com.amit.types.Director result = new com.amit.types.Director();
    ...
    public com.amit.types.Director.Builder name(String name) {
      this.name = name;
      return this;
    }

    public com.amit.types.Director.Builder rating(Integer rating) {
      this.rating = rating;
      return this;
    }

    public com.amit.types.Director.Builder showsDirected(Integer showsDirected) {
      this.showsDirected = showsDirected;
      return this;
    }
  }
